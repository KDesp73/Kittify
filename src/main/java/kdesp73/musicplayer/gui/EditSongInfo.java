...
public class EditSongInfo extends javax.swing.JFrame {
    ...
    public EditSongInfo(MainFrame frame) {
        ...
        artistTextField.setText(frame.currentSong.getArtist().getName());
        albumTextField.setText(frame.currentSong.getAlbum().getName());
    }
    ...
    private void initComponents() {
        ...
        albumCoverTextField.setText("jTextField1");
    ...
    private void applyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_applyButtonActionPerformed
        song.getTrack().setName(titleTextField.getText());
        song.getArtist().setName(artistTextField.getText());
        song.getAlbum().setName(albumTextField.getText());
        song.getAlbum().setCoverPath(albumCoverTextField.getText());
