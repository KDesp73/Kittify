...
public class Tray {
	...
	public static final URL BLUE_CAMPING = Tray.class.getResource("accommodation_camping.glow.0092DA.32.png");
	public static final URL BLACK_FIRE = Tray.class.getResource("amenity_firestation.p.000000.32.png");

	public static final URL BLACK_MAIL = Tray.class.getResource("amenity_post_box.p.000000.32.png");
	public static final URL GREEN_MAIL = Tray.class.getResource("amenity_post_box.p.39AC39.32.png");

	public static final URL BLACK_BUS = Tray.class.getResource("transport_bus_station.p.000000.32.png");
	public static final URL LT_GRAY_BUS = Tray.class.getResource("transport_bus_station.p.999999.32.png");

	public static final URL BLACK_TRAIN = Tray.class.getResource("transport_train_station.p.000000.32.png");
	public static final URL GREEN_TRAIN = Tray.class.getResource("transport_train_station.p.39AC39.32.png");
	public static final URL LT_GRAY_TRAIN = Tray.class.getResource("transport_train_station.p.666666.32.png");

	// from issue 123
	public static final URL NOTIFY_IMAGE = Tray.class.getResource("RemoteNotifications.png");
	...
	public Tray() {
		...
		this.systemTray = SystemTray.get("MusicPlayer");
		if (systemTray == null) {
